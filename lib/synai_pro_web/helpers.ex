defmodule SynaiProWeb.Helpers do
  ...
  def main_menu_items(current_user) do
    SynaiProWeb.Menus.main_menu_items(current_user)
  end

  def user_menu_items(current_user) do
    SynaiProWeb.Menus.user_menu_items(current_user)
  end

  def public_menu_items(current_user) do
    SynaiProWeb.Menus.public_menu_items(current_user)
  end

  def get_menu_item(name, current_user) do
    SynaiProWeb.Menus.get_link(name, current_user)
  end
