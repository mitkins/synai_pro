defmodule SynaiProWeb.AuthRoutes do
    ...
    quote do
      scope "/auth", SynaiProWeb do
        ...
        live_session :current_user,
          on_mount: [{SynaiProWeb.UserOnMountHooks, :maybe_assign_user}] do
      ...
      scope "/auth", SynaiProWeb do
        ...
        live_session :redirect_if_user_is_authenticated,
          on_mount: [{SynaiProWeb.UserOnMountHooks, :redirect_if_user_is_authenticated}] do
