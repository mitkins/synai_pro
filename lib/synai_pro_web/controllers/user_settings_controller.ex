defmodule SynaiProWeb.UserSettingsController do
  use SynaiProWeb, :controller

  alias SynaiPro.Accounts
  alias SynaiPro.Accounts.NotificationSubscriptions
  ...
  def update_password(conn, params) do
    ...
    case Accounts.update_user_password(user, password, user_params) do
      ...
      {:error, changeset} ->
        ...
        |> put_flash(
          :error,
          SynaiProWeb.CoreComponents.combine_changeset_error_messages(changeset)
        )
