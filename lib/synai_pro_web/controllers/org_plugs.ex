defmodule SynaiProWeb.OrgPlugs do
  import Plug.Conn
  ...
  def assign_org_data(conn, _opts) do
    ...
    orgs = SynaiPro.Orgs.list_orgs(conn.assigns.current_user)
    ...
    if org_slug && !current_org do
      ...
      current_membership =
        org_slug && SynaiPro.Orgs.get_membership!(conn.assigns.current_user, org_slug)
