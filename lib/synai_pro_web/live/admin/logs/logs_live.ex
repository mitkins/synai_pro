defmodule SynaiProWeb.LogsLive do
  @moduledoc """
  ...
  alias SynaiPro.Logs.LogQuery

  alias SynaiProWeb.LogsLive.LogDataTableSettings
  alias SynaiProWeb.LogsLive.SearchChangeset
  ...
  def mount(params, _session, socket) do
    if connected?(socket) do
      SynaiProWeb.Endpoint.subscribe("logs")
    end
