defmodule SynaiProWeb.EditProfileLive do
  use SynaiProWeb, :live_view
  import SynaiProWeb.UserSettingsLayoutComponent
  alias SynaiPro.Accounts
  alias SynaiPro.Accounts.User
  alias SynaiProWeb.ImageUpload

  # SETUP_TODO: pick a storage option for images below.
  # Cloudinary setup info: /lib/synai_pro/file_uploads/cloudinary.ex
  # S3 setup info: /lib/synai_pro/file_uploads/s3.ex
  ...
  @upload_provider SynaiPro.FileUploads.Local
  # @upload_provider SynaiPro.FileUploads.Cloudinary
  # @upload_provider SynaiPro.FileUploads.S3
