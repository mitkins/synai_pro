defmodule SynaiPro.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, SynaiPro.Repo)
  ...
  """
  def valid_password?(%SynaiPro.Accounts.User{hashed_password: hashed_password}, password)
