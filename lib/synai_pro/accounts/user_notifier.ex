defmodule SynaiPro.Accounts.UserNotifier do
  @moduledoc """
  When sending an email we use the functions in SynaiPro.Email to generate the Email struct ready for Swoosh to send off.
  ...
  """
  alias SynaiPro.Email
  alias SynaiPro.Mailer
