defmodule SynaiProWeb.OrgPlugsTest do
  use SynaiProWeb.ConnCase, async: true

  setup :register_and_sign_in_user

  setup do
    other_user = SynaiPro.AccountsFixtures.confirmed_user_fixture(%{is_onboarded: true})
    other_org = SynaiPro.OrgsFixtures.org_fixture(other_user)
